...
<div class="max-w-7xl mx-auto space-y-8">
    ...
    <div class="bg-white rounded-xl shadow-lg p-8 border border-blue-100">
        <div class="flex items-center justify-between">
            <div>
                <h1 class="text-3xl font-bold text-blue-900 mb-2">Bookings Overview</h1>
                <p class="text-blue-700 text-lg">Manage and track all your reservations</p>
            </div>
    ...
    <div class="flex justify-end">
        <a href="{{ route('bookings.create') }}" 
           class="inline-flex items-center px-6 py-3 bg-blue-700 text-white text-sm font-medium rounded-lg hover:bg-blue-800 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition-all duration-200 shadow-lg">
                    ...
                    <div class="p-6">
                        ...
                        <div class="flex space-x-2">
                            ...
                            <a href="{{ route('bookings.edit', $booking) }}" 
                               class="flex-1 text-center px-4 py-2 text-sm font-medium text-yellow-700 bg-yellow-50 rounded-lg hover:bg-yellow-100 transition-colors duration-200">
                            ...
                            <form method="POST" action="{{ route('bookings.destroy', $booking) }}" class="flex-1" 
                                ...
                                @method('DELETE')
                                <button type="submit" 
                                        class="w-full px-4 py-2 text-sm font-medium text-red-700 bg-red-50 rounded-lg hover:bg-red-100 transition-colors duration-200">
    ...
    @else
        ...
        <div class="bg-white rounded-xl shadow-lg p-12 text-center border border-blue-100">
            <div class="mx-auto h-24 w-24 bg-blue-50 rounded-full flex items-center justify-center mb-6">
                <i class="fas fa-calendar-times text-blue-200 text-3xl"></i>
            </div>
            <h3 class="text-xl font-semibold text-blue-900 mb-2">No bookings yet</h3>
            <p class="text-blue-700 mb-8 max-w-md mx-auto">Start your journey by creating your first booking. It's quick and easy!</p>
            <a href="{{ route('bookings.create') }}" 
               class="inline-flex items-center px-6 py-3 bg-blue-700 text-white text-sm font-medium rounded-lg hover:bg-blue-800 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition-all duration-200 shadow-lg">
                <i class="fas fa-plus mr-2"></i>
