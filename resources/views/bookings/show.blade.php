...
<div class="max-w-4xl mx-auto space-y-8">
    ...
    <div class="bg-white rounded-xl shadow-lg p-8 border border-blue-100">
        <div class="flex items-center justify-between">
            <div>
                <h1 class="text-3xl font-bold text-blue-900 mb-2">Booking Details</h1>
                <p class="text-blue-700 text-lg">View and manage your reservation</p>
            </div>
    ...
    <div class="bg-white rounded-xl shadow-lg border border-blue-100 overflow-hidden">
        <div class="p-6 
            ...
            @elseif($booking->status === 'pending') bg-yellow-50 border-l-4 border-yellow-500
            ...
            <div class="flex items-center">
                ...
                <div class="ml-4">
                    <h3 class="text-lg font-semibold text-blue-900">Booking Status</h3>
                    <p class="text-blue-700">Your booking is currently 
        ...
        <div class="lg:col-span-2 space-y-6">
            ...
            <div class="bg-white rounded-xl shadow-lg border border-blue-100 p-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        <label class="block text-sm font-medium text-blue-900 mb-2">Booking Title</label>
                        <div class="p-3 bg-blue-50 rounded-lg border border-blue-100">
                            <p class="text-blue-900 font-medium">{{ $booking->title }}</p>
                        </div>
                    </div>
                    
                    <div>
                        <label class="block text-sm font-medium text-blue-900 mb-2">Booking ID</label>
                        <div class="p-3 bg-blue-50 rounded-lg border border-blue-100">
                            <p class="text-blue-900 font-mono text-sm">#{{ $booking->id }}</p>
                        </div>
                    </div>
                    ...
                    <div class="md:col-span-2">
                        ...
                        <div class="p-3 bg-blue-50 rounded-lg border border-blue-100">
                            <p class="text-blue-900">{{ $booking->description }}</p>
                        </div>
                    </div>
                    @endif
                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="bg-blue-50 rounded-xl p-6 border border-blue-200">
                        <div class="flex items-center mb-3">
                            ...
                            <h4 class="text-lg font-semibold text-blue-900">Check-out</h4>
                        </div>
                        <div class="space-y-2">
                            <p class="text-blue-900">
            ...
            <div class="bg-white rounded-xl shadow-lg border border-blue-100 p-6">
                ...
                <div class="space-y-3">
                    <a href="{{ route('bookings.edit', $booking) }}" 
                       class="w-full flex items-center justify-center px-4 py-3 bg-blue-700 text-white text-sm font-medium rounded-lg hover:bg-blue-800 transition-all duration-200 shadow-md">
                    ...
                    <a href="{{ route('bookings.index') }}" 
                       class="w-full flex items-center justify-center px-4 py-3 bg-blue-50 text-blue-900 text-sm font-medium rounded-lg hover:bg-blue-100 transition-all duration-200">
            ...
            <div class="bg-white rounded-xl shadow-lg border border-blue-100 p-6">
                ...
                <div class="space-y-3">
                    <div class="flex items-center text-sm text-blue-900">
                        <i class="fas fa-user-circle w-4 h-4 mr-2 text-blue-400"></i>
                        <span>{{ $booking->user->name }}</span>
                    </div>
                    <div class="flex items-center text-sm text-blue-900">
                        <i class="fas fa-envelope w-4 h-4 mr-2 text-blue-400"></i>
