    ...
    <div class="bg-gradient-to-r from-indigo-600 to-indigo-700 rounded-2xl p-8 text-white">
        <div class="flex items-center justify-between">
            <div>
                ...
                <p class="text-indigo-100 text-lg">Manage your account information</p>
            </div>
                ...
                <div>
                    ...
                    <div class="flex items-center mt-2">
                        <span class="inline-flex items-center px-3 py-1 rounded-full text-sm font-medium 
                            @if(auth()->user()->isAdmin()) bg-yellow-100 text-yellow-800 @else bg-green-100 text-green-800 @endif">
            ...
            <form method="POST" action="{{ route('profile.update') }}" class="space-y-8">
                ...
                <div class="bg-gradient-to-r from-blue-50 to-purple-50 rounded-xl p-6 border border-blue-200">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                        ...
                        <div class="text-center p-4 bg-white rounded-lg border border-yellow-200">
                ...
                <div class="flex flex-col sm:flex-row gap-4 pt-6 border-t border-gray-200">
                    <button type="submit" 
                            class="flex-1 sm:flex-none inline-flex items-center justify-center px-6 py-3 border border-transparent text-sm font-medium rounded-lg text-white bg-gradient-to-r from-blue-500 to-purple-600 hover:from-blue-600 hover:to-purple-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition-all duration-200 shadow-lg transform hover:-translate-y-1">
